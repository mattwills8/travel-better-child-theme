				...
				<div class="theiaStickySidebar">
					<div class="archive-box">
						<div class="title-bar">
							...
							elseif ( is_tax( 'tb-photographer' ) ) :
								echo '<span>';
								echo penci_get_setting( 'penci_trans_photographer' );
								echo ' </span>';
								printf( wp_kses ( __( '<h1>%s</h1>', 'soledad' ), penci_allow_html() ), $wp_query->get_queried_object()->name );
							else :
								echo '<h1>';
								echo penci_get_setting( 'penci_trans_archives' );
								echo '</h1>';
