...
if ( $categories ) {
	...
	if ( $my_query->have_posts() ) {
		...
		$you_may_also_like_translation = penci_get_setting( 'penci_trans_you_may_also_like' );

		$you_may_also_like = $you_may_also_like_translation ?
			$you_may_also_like_translation :
			penci_get_setting( 'penci_post_related_text' );
		?>
		<div class="post-related">
		<div class="post-title-box"><h4 class="post-box-title"><?php echo $you_may_also_like; ?></h4></div>
