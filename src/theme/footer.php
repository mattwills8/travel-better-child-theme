...
$tb_footer_background_class = $use_tb_footer_background ? 'footer-background-enabled' : '';
$tb_background_image = $tb_upload_footer_backgrond;
...
<div class="footer-background-image <?php echo $tb_footer_background_class; ?>" style="background-image: url('<?php echo $tb_background_image; ?>')"> <!-- start footer-background-image -->
...
</div> <!-- End footer-background-image -->
